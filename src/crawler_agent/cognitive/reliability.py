...
class ReliabilityManager:
    ...
    def record_health(self, name: str, success: bool, response_time_ms: float = 0.0, error: str = None):
        ...
        status.avg_response_time_ms = sum(self._response_times[name]) / len(self._response_times[name])
...
def circuit_breaker(
    ...
    _breaker = CircuitBreaker(name, CircuitBreakerConfig(
...
_reliability_manager: Optional[ReliabilityManager] = None
